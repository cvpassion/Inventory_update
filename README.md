...
1. Scan the QR code listed on main page as "qr.png". It takes you to the webpage. It might take a few seconds, up to a minute for the webpage to load, depending on the inactivity status.
