...
2. Once you click add entry/existing entry on the page, it directs you to the login page for email verification. It is restrcied to users with an andrew id. You have to enter your cmu id, else it wouldn't let you proceed.
